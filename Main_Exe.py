...
#                 word_sentence = self.tokenizer_eng(s)
...
# from CreateDataset import Creating_Dataset
# from Encoder import encoderRNN
# from Decoder import decoderRNN
# from Models import MODELS
# from Model_Train_Test import training
...
# training_json = 'training_label.json'
# training_feats = 'training_data/feat'
# testing_json = 'testing_label.json'
...
#     dropout_percentages = [0.1,0.2,0.3,0.4]
        ...
        for hidden_size in hidden_sizes:
            for dropout_percentage in dropout_percentages:
                for word_dim in word_dims:
                    ...
                    model_name = "model_v2_batchSize_"+str(batch_size)+"_hidSize_"+ str(hidden_size) + "_dropPer_"+str(dropout_percentage) + "_wordDim_"+str(word_dim)
...
def testmodel(arg):
    ...
    # Bleu Eval
        ...
        result_pd.to_csv("temp_result2.csv",index=False)


    result_pd.to_csv("final_result2.csv",index=False)
